    ...
    return (
        <>
         <div className="flex flex-col justify-center items-center bg-white h-screen font-mono py-40">
            <img src={DM1} alt="" className="h-full rounded mb-20 shadow" />
            <div className="flex flex-col justify-center items-center">
                <h2 className="text-2xl mb-2">Como un básico se transforma en una prenda exótica</h2>
                <h2 className="text-1xl mb-1">Domingo Domingo</h2>
                <h4 className="text-1xl mb-1">De Argentina al Universo, el salto que define a Domingo es Domingo</h4>
                ...
                <p className="mb-2">Loco, no? Pero esta es la energía que maneja la marca. Una energía innovadora que te invita a romper con las estructuras y tendencias establecidas y te deja que seas vos el que marca su propia identidad con prendas pensadas. “La idea es que se coman el mismo viaje que el diseñador”
